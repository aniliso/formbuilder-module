...
class FormbuilderController extends AdminBaseController
{
    ...
    public function store(FormbuilderRequest $request)
    {
        ...
        return redirect()->route('admin.formbuilder.formbuilder.index')->withSuccess(trans('core::core.messages.resource created', ['name' => trans('formbuilder::formbuilder.title.form')]));
    }
    ...
    public function update($id, FormbuilderRequest $request)
    {
        ...
        return redirect()->route('admin.formbuilder.formbuilder.index')->withSuccess(trans('core::core.messages.resource updated', ['name' => trans('formbuilder::formbuilder.title.form')]));;
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.formbuilder.formbuilder.index')->withSuccess(trans('core::core.messages.resource deleted', ['name' => trans('formbuilder::formbuilder.title.form')]));;
    }
}
